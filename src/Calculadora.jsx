...
// ---------- Referência de demanda e PREÇO DE REVENDA (seminovo) por modelo, NÍVEL NACIONAL ----------
...
// Pesquisado em 12/08/2026 a partir de fontes que agregam preços de todo o Brasil — não de uma
// cidade específica: Trocafone, Trocafy, Brused, Celulares Usados, TechLoad, Canaltech, TechTudo,
// Oficina da Net, Seletronic, Tecnoblog, Mercado Livre e OLX (nível nacional).
// Ainda é uma REFERÊNCIA, não um preço travado — o mercado de seminovo varia por estado de
// bateria, tela e capacidade (GB), e por a venda ser pra loja (recompra, ~30-40% abaixo) ou pra
// pessoa física (Mercado Livre/OLX, mais alto). Modelos muito recentes (iPhone 17, Galaxy S26)
// têm pouca oferta de usado ainda e por isso faixas mais estreitas e com menos precisão.
const DATA_REFERENCIA_NACIONAL = "12/08/2026";
const REFERENCIA_MODELOS = [
  // ---------- Apple ----------
  { chave: "iphone 17", demanda: "Média", faixa: [5200, 6800] },
  { chave: "iphone 16", demanda: "Alta", faixa: [4000, 5300] },
  ...
  { chave: "iphone 8", demanda: "Baixa", faixa: [550, 880] },
  // ---------- Samsung ----------
  { chave: "galaxy s26", demanda: "Média", faixa: [5500, 7200] },
  { chave: "galaxy s25", demanda: "Alta", faixa: [2200, 3200] },
  ...
  { chave: "galaxy a56", demanda: "Alta", faixa: [1600, 2200] },
  { chave: "galaxy a36", demanda: "Alta", faixa: [1200, 1700] },
  { chave: "galaxy a26", demanda: "Média", faixa: [900, 1300] },
  { chave: "galaxy a17", demanda: "Alta", faixa: [700, 950] },
  { chave: "galaxy a16", demanda: "Alta", faixa: [550, 800] },
  ...
  // ---------- Xiaomi / Redmi / POCO ----------
  { chave: "redmi note 14", demanda: "Alta", faixa: [900, 1400] },
  { chave: "redmi note 13", demanda: "Alta", faixa: [700, 1050] },
  { chave: "redmi note 12", demanda: "Alta", faixa: [650, 950] },
  { chave: "redmi note 11", demanda: "Alta", faixa: [550, 850] },
  { chave: "redmi 13", demanda: "Média", faixa: [550, 800] },
  { chave: "redmi 12", demanda: "Média", faixa: [500, 750] },
  { chave: "poco x7", demanda: "Média", faixa: [1600, 2200] },
  { chave: "poco x5", demanda: "Média", faixa: [700, 1000] },
  // ---------- Motorola ----------
  { chave: "moto g85", demanda: "Média", faixa: [950, 1300] },
  { chave: "moto g84", demanda: "Média", faixa: [900, 1400] },
  { chave: "moto g55", demanda: "Média", faixa: [700, 1000] },
...
export default function Calculadora() {
  ...
  // 1) preço de mercado que você mesmo viu  2) referência nacional pesquisada por modelo.
  const origemVenda = nMercado > 0 ? "mercado" : ref ? "nacional" : null;
  ...
  return (
    <div>
        <h2 className="display" style={{ fontSize: 22, fontWeight: 700, margin: "0 0 4px" }}>
          Calculadora (Comparativo)
        </h2>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              ...
              <div style={{ fontSize: 11, color: "#5A626B", marginTop: 16, lineHeight: 1.5 }}>
                Quando você não informa um preço de mercado visto por você mesmo, a demanda, a
                margem e o preço de revenda usam a referência nacional (atualizada em{" "}
                {DATA_REFERENCIA_NACIONAL} a partir de Trocafone, Trocafy, Brused, Celulares
                Usados, TechLoad, Canaltech, Oficina da Net e Mercado Livre/OLX em nível
                nacional — não uma cidade específica). É uma referência de mercado, não um preço
                travado: varia com estado da bateria, tela, capacidade (GB) e se a venda é pra
                loja (recompra, mais baixo) ou pra pessoa física (mais alto). Reconfirme os
                valores antes de fechar negócio.
              </div>
            </div>
